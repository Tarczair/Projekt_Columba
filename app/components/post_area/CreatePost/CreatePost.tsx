        ...
        <div className={styles.createPostContainer}>
            ...
            <div className={styles.formWrapper}>
                ...
                <div className={styles.contentRow}>
                    ...
                    <div className={styles.uploadBox} onClick={handleUploadClick}>
                        <input 
                            ...
                            accept="image/*,video/*"
                        />
                        <ArrowForwardIcon className={styles.uploadIcon} style={{ transform: 'rotate(-45deg) scale(2)' }} />
                ...
                <div className={styles.actionButtons}>
                    <button className={styles.blueBtn} onClick={() => setIsTagModalOpen(true)}>WYBIERZ TAGI <ArrowForwardIcon className={styles.btnIcon}/></button>
                    {isTagModalOpen && (
                        <Tag 
                    ...
                    <label className={styles.spoilerLabel}>
                        ...
                        <div className={styles.spoilerButton}>
                            <span>SPOILER</span>
                            <div className={`${styles.checkCircle} ${isSpoiler ? styles.active : ''}`}>
                                <CheckIcon className={styles.checkIcon} />
                            </div>
                        </div>
                    </label>

                    <button className={styles.sendBtn}>WYŚLIJ <ArrowForwardIcon className={styles.btnIcon}/></button>
                </div>
            </div>
        </div>
    );
